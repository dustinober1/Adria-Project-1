"""
Main FastAPI application - Production Optimized Version
"""
...
frontend_urls_dev = os.getenv("FRONTEND_URL_DEV", "").split(",")
...
app.add_middleware(
    ...
    allow_methods=["*"],
    allow_headers=["*"],
    # In production, you may want to be more specific about exposed headers
